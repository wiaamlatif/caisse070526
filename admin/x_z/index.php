            ...
            <tr>
                ...
                <td>
                  <div class="d-flex py-2">                    
                    ...
                    <a href="suprim.php?id=<?=$idz?>" class="btn btn-warning btn-sm mx-1"
                       onclick="return confirm('Confirmez la suppression de<?=$idz?>?')">Sellers</a>
                    <a href="suprim.php?id=<?=$idz?>" class="btn btn-success btn-sm mx-1"
                       onclick="return confirm('Confirmez la suppression de<?=$idz?>?')">Clients</a>          
                  </div>
                </td>    
            </tr>  
          <?php     
