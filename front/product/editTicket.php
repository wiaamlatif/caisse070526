...
if(isset($_SESSION['currentIdTicket'])){
    ...
    $_SESSION['oldIdTicket'] = $_SESSION['currentIdTicket'];  
    $_SESSION['currentIdTicket']= $idTicket;

} else {

    $_SESSION['currentIdTicket'] = 0;
...
$lastIdInserted=0;
if(isset($_SESSION['lastIdInserted'])){
  $lastIdInserted = $_SESSION['lastIdInserted'];  
}
